...
public class Sighting {
  ...
  public String getTimeSighted() {
    return DateFormat.getDateTimeInstance().format(time_sighted);
  }
  ...
  public void save() {
    try(Connection con = DB.sql2o.open()) {
      String sql = "INSERT INTO sightings (animal_id, location, ranger_name, time_sighted) VALUES (:animal_id, :location, :ranger_name, now());";
